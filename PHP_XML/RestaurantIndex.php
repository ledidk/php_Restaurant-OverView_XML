...
<body>
    <form action="" id="form" method="post">
        ...
        <div id="dropdown">
            ...
            <select id="enter" name="restaurant">
        ...
        <br><br><!-- displaying error message below -->
...
<?php if (!empty($restaurantSelected)) {
    echo "Selected restaurant is not empty :";
    foreach ($restaurantSelected as $value) {
        echo $value . "\n";
    }
} ?>
